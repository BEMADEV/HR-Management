                ...
                <div class="panel-body">
                    <div class="grid grid-panel">
                        ...
                        <Rock:Grid ID="gPtoRequestList" runat="server" RowItemText="Request" OnRowSelected="gPtoRequestList_Edit" AllowSorting="true" CssClass="js-grid-request-list">
                            <Columns>
                                <Rock:SelectField />
                                <Rock:RockBoundField DataField="PtoAllocation.PersonAlias.Person.FullName" HeaderText="Person" SortExpression="PersonAlias.Person.LastName,PersonAlias.Person.LastName" />
                                <Rock:RockBoundField DataField="PtoAllocation.PtoType" HeaderText="PTO Type" SortExpression="PtoType.Name" />
                                ...
                                <Rock:RockLiteralField HeaderText="Status" ID="lRequestStatus" SortExpression="Status" HeaderStyle-CssClass="grid-columnstatus" ItemStyle-CssClass="grid-columnstatus" FooterStyle-CssClass="grid-columnstatus" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" OnDataBound="lRequestStatus_DataBound" ExcelExportBehavior="NeverInclude" />
                                <Rock:RockBoundField DataField="PtoRequestApprovalState" HeaderText="Status" Visible="false" ExcelExportBehavior="AlwaysInclude" />
                            </Columns>
                        </Rock:Grid>
                    </div>
                </div>
