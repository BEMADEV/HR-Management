            ...
            <div class="panel-body">
                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <Rock:DaysOfWeekPicker ID="daysOfWeekPicker" RepeatDirection="Horizontal" runat="server" Label="Weekend Days" Help="Select the days of the week that should be considered the weekend here." />
                        </div>
                    </div>
