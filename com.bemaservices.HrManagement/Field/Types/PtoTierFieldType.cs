...
namespace com.bemaservices.HrManagement.Field.Types
{
    ...
    [FieldTypeGuid( "45D50588-09B4-488A-A794-8C27150BA344" )]
    class PtoTierFieldType : UniversalItemPickerFieldType, IEntityFieldType
    {
        /// <summary>
        ...
        protected override List<ListItemBag> GetListItems( Dictionary<string, string> privateConfigurationValues )
        {
            ...
            return new PtoTierService( new RockContext() ).Queryable()
