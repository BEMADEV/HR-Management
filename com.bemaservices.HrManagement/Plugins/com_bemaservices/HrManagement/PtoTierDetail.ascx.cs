    ...
    public partial class PtoTierDetail : RockBlock, IDetailBlock
    {
        ...
        protected void btnSave_Click( object sender, EventArgs e )
        {
            ...
            using ( var rockContext = new RockContext() )
            {
                ...
                ptoTier.DaysOfWeek = daysOfWeekPicker.SelectedValuesAsInt.AsDelimited( "," );
        ...
        private void ShowEditDetails( PtoTier ptoTier )
        {
            ...
            if ( ptoTier.DaysOfWeek.IsNullOrWhiteSpace() )
            {
                daysOfWeekPicker.SelectedDaysOfWeek = "0,6".Split( ',' ).Select( a => ( DayOfWeek ) a.AsInteger() ).ToList();
            }
            else
            {
                daysOfWeekPicker.SelectedDaysOfWeek = ptoTier.DaysOfWeek.Split( ',' ).Select( a => ( DayOfWeek ) a.AsInteger() ).ToList();
            }
